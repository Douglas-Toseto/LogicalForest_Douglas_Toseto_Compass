...
function verificaEntrada(){
    ...
    //estava tentando fazer as seleções com Switch/Case aninhados
    /* switch (convite){
        case 'Jonatan': //pessoa que convidou
    ...
    if (Object.keys(listaConvidades).includes(convite) && listaConvidades[convite].includes(nome)){
        document.getElementById('resultado').innerHTML = "Você pode entrar!";
    } else {
        document.getElementById('resultado').innerHTML = "Você NÃO pode entrar!";
    }
